...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'NitrossRoboto' : process.env.OWNER_NAME,
    CP_TEXT: process.env.CP_TEXT === undefined ? '꧁༺ʍǟɖɛ ɮʏ Nitross Bot༻꧂\n𓂀 𝕝𝕖𝕘𝕖𝕟𝕕 𝕓𝕠𝕥 𝕠𝕗 𝕤𝕣𝕚 𝕝𝕒𝕟𝕜𝕒 𓂀' : process.env.CP_TEXT,
    SONG_UP: process.env.SONG_UP === undefined ? '꧁•٭𝚙𝚕𝚣 𝚠𝚊𝚒𝚝𝚎 Nitross Bot 𝚞𝚙𝚕𝚘𝚊𝚍𝚒𝚗𝚐 𝚢𝚘𝚞𝚛 𝚜𝚘𝚗𝚐 𝚚𝚞𝚒𝚌𝚔𝚕𝚢٭•꧂' : process.env.SONG_UP,
    VIDEO_DOWN: process.env.VIDEO_DOWN === undefined ? '(づ｡◕‿‿◕｡)づ Nitross Bot ∂σωηℓσα∂ιηg уσυя νι∂єσ ٩(˘◡˘)۶' : process.env.VIDEO_DOWN,
    VID_CP: process.env.VID_CP === undefined ? '♣💎  Ř𝕒V𝓪Ｎ𝐚 𝔂ŤⒹ𝕃  ♜✌' : process.env.VID_CP,
    VIDEO_UP: process.env.VIDEO_UP === undefined ? '(づ｡◕‿‿◕｡)づ Nitross Bot υρℓσα∂ιηg уσυя νι∂єσ ٩(˘◡˘)۶' : process.env.VIDEO_UP,
